...
struct Adventure {
    static func story(name: String) -> Page {
        ...
        let _ = rover.addChoice(title: "Return to Earth", page: home)
        
        let _ = cave.addChoice(title: "Continue towards faint light", story: .Droid(name))
        let _ = cave.addChoice(title: "Refill the ship and explore the rover", page: rover)
        
        let _ = crate.addChoice(title: "Explore the Rover", page: rover)
        let _ = crate.addChoice(title: "Use the key", story: .Monster)
